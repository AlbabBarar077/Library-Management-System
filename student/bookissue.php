...
<div id="main">
        ...
        <tr><td>Publication</td><td><input type="text" name="t4"/></td></tr>
         <tr><td>Issue Date</td><td><input type="date" name="t5"/></td></tr>
...
if(isset($_POST['submit']))
{
    ...
    $sql="insert into issuebook(studentid,bookname,author,publication,issuedate )values('".$studentid."','".$bookname."','".$author."','".$publication."','".$issuedate."')";
            $re=$con->query($sql);
            if($re==True)
            {
